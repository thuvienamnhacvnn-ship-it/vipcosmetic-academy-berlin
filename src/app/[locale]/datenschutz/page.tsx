  ...
  return (
    <div className="mx-auto max-w-2xl px-5 pb-24 pt-5 lg:pt-32 text-sm leading-relaxed text-muted">
      ...
      <p className="mt-6">
        ...
        keine Weitergabe zu Werbezwecken statt. Rechtsgrundlage ist Art. 6 Abs. 1 lit. b und f DSGVO.
      </p>
      <p className="mt-4">
        Sie haben das Recht auf Auskunft, Berichtigung, Löschung und Beschwerde bei einer
        Aufsichtsbehörde.
      </p>
    </div>
  );
